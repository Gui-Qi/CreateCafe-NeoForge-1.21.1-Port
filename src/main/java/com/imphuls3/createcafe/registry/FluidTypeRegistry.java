...
//            .density(1200).viscosity(1500).temperature(295);
//
//    public static final DeferredHolder<FluidType, FluidType> MELTED_SUGAR = FLUID_TYPES.register("melted_sugar",() -> new FluidType(FLUID_PROPERTIES){
//    });
//
//    public static final DeferredHolder<FluidType, FluidType> STRAWBERRY_TEA = FLUID_TYPES.register("strawberry_tea",() -> new FluidType(FLUID_PROPERTIES){
//    });
//
