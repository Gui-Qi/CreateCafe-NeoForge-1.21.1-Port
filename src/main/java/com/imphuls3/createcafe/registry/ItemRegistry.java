...
public class ItemRegistry {
    ...
    //Non Food Items
    public static final DeferredHolder<Item, Item> BOBA_CUP = SimpleRegistry("boba_cup");
    public static final DeferredHolder<Item, Item> EMPTY_BOBA_CUP = SimpleRegistry("empty_boba_cup");
    public static final DeferredHolder<Item, Item> ICED_COFFEE_CUP = SimpleRegistry("iced_coffee_cup");
    public static final DeferredHolder<Item, Item> ICED_COFFEE_CUP_ICE = SimpleRegistry("iced_coffee_cup_ice");
    ...
    public static <T extends Item> DeferredHolder<Item, Item> SimpleRegistry(String name){
