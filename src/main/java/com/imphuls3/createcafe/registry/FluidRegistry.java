...
import com.imphuls3.createcafe.registry.FluidTypeRegistry.*;
...
public class FluidRegistry {
    ...
    public static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse(MODID + ":block/milk_tea_still");
    public static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse(MODID + ":block/milk_tea_flow");
